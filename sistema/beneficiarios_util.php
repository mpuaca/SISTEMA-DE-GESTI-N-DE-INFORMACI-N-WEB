    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h4>Lista de Beneficiarios de Utiles Escolares</h4>
                <div class="rounded-utiles h-100 p-4">
                    <div class="table-responsive">
                        <table class="table" id="example">
                            ...
                            <?php
                            $query = mysqli_query($conection, "SELECT BeneficiarioID, nombre, telefono, dpi, observaciones, propósito FROM beneficiarios WHERE propósito = 'útiles_escolares'OR propósito = 'ambos' ORDER BY BeneficiarioID");

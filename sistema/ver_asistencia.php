...
<body>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a class="me-md-2" aria-current="page" href="asistencia_catecumenos.php">Asistencias</a>
                    </li>
                    <li class="nav-item">
                        <a class="me-md-2 active1" href="ver_asistencia.php">Ver Asistencias</a>
                    </li>
                </ul>
                <div class="h-100 p-4">
                    ...
                    <table class="table table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            $sqlEstudiantes = "SELECT Id, nombre FROM estudiantes";
                            $resultadoEstudiantes = $conection->query($sqlEstudiantes);

                            while ($filaEstudiante = $resultadoEstudiantes->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>{$filaEstudiante['Id']}</td>";
                                echo "<td class='nombre'>{$filaEstudiante['nombre']}</td>";
                                ...
                                $sqlAsistencias = "SELECT DATE_FORMAT(Fecha, '%d/%m/%Y') AS Fecha, asistio FROM asistencia WHERE id_estudiante = {$filaEstudiante['Id']}";
                                ...
                                while ($filaAsistencia = $resultadoAsistencias->fetch_assoc()) {
                                    $index = array_search($filaAsistencia['Fecha'], $fechasEncabezado);
                                    if ($index !== false) {
    ...
    <script src="https://cdnjs.cloudflare.com/ajaxlibs/pdfmake/0.2.7/vfs_fonts.js"></script>

        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="h-100 p-4">
                    ...
                    <a href="agregar_usuario.php" class="btn btn-primary me-md-2 btn-agregar">Agregar Usuario</a>
                    <div class="table-responsive">
                        <table id="example" class="table">
                            ...
                            $query = mysqli_query($conection, "SELECT u.id, u.nombre, u.correo,r.rol FROM usuarios u INNER JOIN roles r ON u.rol = r.idrol WHERE estado = 1 ORDER BY u.id ");
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="link_edit" href="editar_usuario.php?id=<?php echo $data["id"]; ?>"><i class="fas fa-edit fa-lg" style="color: #1c5e87;"></i></a>

                                            <?php if ($data["id"] != 1) { ?>
                                                |
                                                <a class="link_delete" onclick="eliminar_usuario(<?php echo $data['id']; ?>)"><i class="fas fa-trash-alt fa-lg" style="color: #c91313;"></i></a>
                                            <?php } ?>

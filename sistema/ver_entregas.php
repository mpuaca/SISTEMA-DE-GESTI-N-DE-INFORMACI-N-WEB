...
$sql = "SELECT DISTINCT DATE_FORMAT(FechaEntrega, '%d/%m/%Y') AS FechaEntrega FROM entregas";
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a class="me-md-2 " aria-current="page" href="entegras_donaciones.php">Entregas</a>
                    </li>
                    <li class="nav-item">
                        <a class="me-md-2 active1" href="ver_entregas.php">Ver Reporte</a>
                    </li>
                </ul>
                <div class="h-100 p-4">
                    ...
                    <table class="table table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            $sqlEstudiantes = "SELECT BeneficiarioID, nombre FROM beneficiarios WHERE propósito = 'alimentos' OR propósito = 'ambos'";
                            ...
                            while ($filaEstudiante = $resultadoEstudiantes->fetch_assoc()) {
                                ...
                                $sqlAsistencias = "SELECT DATE_FORMAT(FechaEntrega, '%d/%m/%Y') AS FechaEntrega, asistio FROM entregas WHERE BeneficiarioID = {$filaEstudiante['BeneficiarioID']}";
    ...
    <script>
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "buttons":[{
                extend: 'excelHtml5',
                title: 'Lista entrega de Alimentos',
                text: '<i class="fas fa-file-excel"></i>Excel',
                className: 'btn btn-success', // Clase personalizada para el botón Excel
                exportOptions: {
                  columns: [0, 1, 2, 3,4], // Índices de las columnas a incluir en el Excel
                }
              },],
                "columns": [{
                        "data": "ID"

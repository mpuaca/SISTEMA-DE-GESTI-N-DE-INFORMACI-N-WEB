    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="h-100 p-4">
                    <h4 class="mb-4">Lista de Benefactores</h4>
                    <a href="agregar_benefactores.php" class="btn btn-primary me-md-2 btn-agregar">Agregar Benefactor</a>
                    <div class="table-responsive">
                        <table class="table" id="example">
                            ...
                            $query = mysqli_query($conection, "SELECT DonanteID,nombre,telefono,direccion FROM donantes ORDER BY DonanteID ");
                            ...
                            ?>
                                    <tr>
                                        <td><?php echo $data["DonanteID"]; ?></td>
                                        <td class="nombre"><?php echo $data["nombre"]; ?></td>
                                        <td><?php echo $data["telefono"]; ?></td>
                                        <td><?php echo $data['direccion'] ?></td>
                                        <td>
                                            <a class="link_edit" href="editar_benefactores.php?id=<?php echo $data["DonanteID"]; ?>"><i class="fas fa-edit fa-lg" style="color: #1c5e87;"></i></a>
                                            <?php if ($data["DonanteID"]) { ?>
                                                <a class="link_delete" onclick="eliminar_benefacto(<?php echo $data['DonanteID']; ?>)"><i class="fas fa-trash-alt fa-lg" style="color: #c91313;"></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
        ...
        <script src="js/table_benefactores.js"></script>

        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a class="me-md-2 active1" aria-current="page" href="inventario.php">Alimentos</a>
                    </li>
                    <li class="nav-item">
                        <a class="me-md-2" href="utilies_escolares.php">Utilies escolares</a>
                    </li>
                </ul>
                <div class="h-100 p-4">
                    <a href="combo_alimentos.php" class="btn btn-primary me-md-2 btn-agregar">Combo </a>
                    <div class="table-responsive">
                        <table class="table" id="example">
                            ...
                            $query = mysqli_query($conection, "SELECT NombreProducto, Cantidad,medida FROM inventario WHERE Categoria = 'alimentos'");
